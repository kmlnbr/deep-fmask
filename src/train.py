"""
This script is used to train the network at each stage of the self-training
framework.
"""
...
def get_args(argv=None):
    ...
    parser.add_argument('--full', dest='full', action='store_true',
                        default=False,
                        help='Train the largest network in the pipeline using '
                             'the complete dataset on the F-Mask labels, '
                             'i.e., supervised learning using F-Mask labels')
    ...
    parser.add_argument('--no_aug', dest='aug',
                        action='store_false', default=True,
                        help='Flag used to avoid use of augmentation in '
                             'training data')

    parser.add_argument('--reset_stage_data', dest='reset_stage_data',
                        action='store_true', default=False,
                        help='Flag used reassign h5 files for each stage of '
...
if __name__ == '__main__':
    ...
    # Get the weights for the loss functions using the median frequency
    # balancing method
